...
class BookingCSVExportTests(APITestCase):
    ...
    def test_csv_export_headers_and_body(self):
        ...
        self.assertTrue(content[0].startswith("id,created_at,customer_name,phone,email,event_type,event_date_start,event_date_end,event_all_day,guests,package_id,dietary_needs,status,workflow_status,deposit_paid,notes"))
